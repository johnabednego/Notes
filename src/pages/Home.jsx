...
const Home = () => {
    ...
    return (
        <div>
            {addNoteModal?<AddNote setAddNoteModal={setAddNoteModal}/>:null}
            <div className=' w-full mt-[1em] mb-[4em] mx-auto p-[15px] max-w-[854px]'>
                <div className=' w-[calc(100%+24px)] m-[-12px] flex flex-col flex-wrap box-border'>
                    ...
                    <div className=' p-[12px] m-0 box-border w-full flex flex-col-reverse md:flex-row'>
                        ...
                        <div className=' md:flex-grow-0 md:max-w-[75%] md:basis-[75%] mt-3 md:mt-0 md:m-0 box-border w-full flex flex-wrap'>
                            <div className=' w-full flex items-center justify-evenly flex-wrap gap-4'>
                                ...
                                <button onClick={() => setSwitchTab(1)} type="button" className={` ${switchTab === 1 ? 'text-[#fff] bg-[#ff9100] cursor-not-allowed' : 'cursor-pointer bg-transparent'} align-middle items-center outline-[0] m-0 cursor-pointer border-0 tracking-[0.02857em] rounded-[4px] leading-[1.75] relative min-w-[89px] font-normal  shadow-none py-[6px] px-[8px] text-[#000000de] text-[0.875rem] transition-custom duration-250 ease-custom-ease delay-0`}>
                                ...
                                <button onClick={() => setSwitchTab(2)} type="button" className={` ${switchTab === 2 ? 'text-[#fff] bg-[#5c6bc0] cursor-not-allowed' : 'cursor-pointer bg-transparent'} align-middle items-center outline-[0] m-0 cursor-pointer border-0 tracking-[0.02857em] rounded-[4px] leading-[1.75] relative min-w-[89px] font-normal  shadow-none py-[6px] px-[8px] text-[#000000de] text-[0.875rem] transition-custom duration-250 ease-custom-ease delay-0`}>
                                ...
                                <button onClick={() => setSwitchTab(3)} type="button" className={` ${switchTab === 3 ? 'text-[#fff] bg-[#66bb6a] cursor-not-allowed' : 'cursor-pointer bg-transparent'} align-middle items-center outline-[0] m-0 cursor-pointer border-0 tracking-[0.02857em] rounded-[4px] leading-[1.75] relative min-w-[89px] font-normal  shadow-none py-[6px] px-[8px] text-[#000000de] text-[0.875rem] transition-custom duration-250 ease-custom-ease delay-0`}>
                                ...
                                <button onClick={() => setSwitchTab(4)} type="button" className={` ${switchTab === 4 ? 'text-[#fff] bg-[#51336A] cursor-not-allowed' : 'cursor-pointer bg-transparent'} align-middle items-center outline-[0] m-0 cursor-pointer border-0 tracking-[0.02857em] rounded-[4px] leading-[1.75] relative min-w-[89px] font-normal  shadow-none py-[6px] px-[8px] text-[#000000de] text-[0.875rem] transition-custom duration-250 ease-custom-ease delay-0`}>
                    ...
                    {/**Various Categories */}
                    <div className=' mt-6 p-[12px] flex-grow-0 basis-full max-w-full m-0 box-border'>
                        {switchTab === 0 ? <AllNote notes={allNotes} /> : null}
                        {switchTab === 1 ? <HomeNote notes={homeNotes} /> : null}
                        {switchTab === 2 ? <WorkNote notes={workNotes} /> : null}
                        {switchTab === 3 ? <PersonalNote notes={personalNotes} /> : null}
                        {switchTab === 4 ? <OtherNote notes={otherNotes} /> : null}
                    </div>
